...
<div class="overlay">
  ...
  {#if !onboarding}
    ...
    <div class="content">
      ...
      <section class="">
        <div class="mx-auto flex flex-col sm:flex sm:flex-row sm:flex-wrap sm:justify-center sm:gap-[14px]">
          <!-- Creator Plan -->
          <div
            class="bg-gray-900 p-8 shadow ring-1 ring-gray-200"
          >
            <span
              class=" text-sm bg-white font-semibold text-gray-600 px-2 py-0.5 rounded"
              >Most popular</span
            >
            <h3 class=" mt-3 text-xl font-semibold text-white">Creator</h3>
            <p class="mt-2 text-base text-white">
              Best for Small Creators. 2x monthly limit.
            </p>
            <p class="mt-8 text-4xl font-bold text-white">
              $49 <span class="text-base font-normal text-white"
                >per month</span
              >
            </p>
            <button
              ...
              <li class="flex gap-1 items-center">
                ...
                >
                  <path
                    ...
                    fill="#4f46e5"
                  />
                </svg> You get +2k EXTRA credits per month.
              </li>
              <li class="flex gap-1 items-center">
                <svg
                  width="18px"
                ...
                >
                  <path
                    ...
                    fill="#4f46e5"
                  />
                </svg> 4k TOTAL monthly credits (2x monthly limit)
              </li>
              <li class="flex gap-1 items-center">
                <svg
                  width="18px"
                ...
                >
                  <path
                    ...
                    fill="#4f46e5"
                  />
                </svg> Perfect for growing creators
              </li>
            </ul>
          </div>
          <!-- Creator Plus Plan -->
          ...
          >
            ...
            <p class="mt-8 text-4xl font-bold text-black">
              $99 <span class="text-base font-normal text-black"
                >per month</span
              >
            </p>
            <button
              ...
              <li class="flex gap-1 items-center">
                ...
                >
                  <path
                    ...
                    fill="#898989"
                  />
                </svg> +6k EXTRA credits per month.
              </li>
              <li class="flex gap-1 items-center">
                <svg
                  width="18px"
                ...
                >
                  <path
                    ...
                    fill="#898989"
                  />
                </svg> 8k TOTAL monthly credits (4x monthly limit)
              </li>
              <li class="flex gap-1 items-center">
                <svg
                  width="18px"

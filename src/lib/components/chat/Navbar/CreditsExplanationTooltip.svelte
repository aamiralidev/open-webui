...
<div class="modal-wrapper" bind:this={tooltipEl}>
	...
	<div class="modal-container bg-white dark:bg-gray-900">
		...
		<button class="add-credits-btn" on:click={showUpgradeOverlay}> Add more credits </button>

		<h3 class="how-it-works">How it Works:</h3>

		<p class="explanation">
			Credits get used every time you chat with the AI. The more videos, voice notes, docs, or
			websites you use to power up your chat... The more credits you invest.
		</p>

		<p class="explanation">
			You have {formatCredits($user.credit_limit)} credits per month. Once you run out of credits...
			You'll have to wait until next month or upgrade to a power user plan to unlock more credits and
			features!
		</p>
